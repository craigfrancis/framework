...
// Post app specified defaults
	...
	// Output
		...
		config::set_default('output.js_default_defer', (preg_match('/MSIE [5-9]\./', config::get('request.browser')) ? false : true)); // https://github.com/h5bp/lazyweb-requests/issues/42#issuecomment-1896139
