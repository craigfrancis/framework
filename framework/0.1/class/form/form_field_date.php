		...
		// HTML
			...
			public function html_label($part = 'D', $label_html = NULL) {
				...
				// Return the HTML for the label
					...
					return '<label for="' . html($this->id) . '_' . html($part) . '"' . ($this->label_class === NULL ? '' : ' class="' . html($this->class_label) . '"') . '>' . ($required_mark_position == 'left' && $required_mark_html !== NULL ? $required_mark_html : '') . ($label_html !== NULL ? $label_html : $this->label_html) . ($required_mark_position == 'right' && $required_mark_html !== NULL ? $required_mark_html : '') . '</label>';
