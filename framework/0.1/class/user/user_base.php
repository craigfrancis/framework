...
// Base user class
	...
	class user_base extends check {
		...
		// Setup
			...
			protected function _setup() {
				...
				// Handlers
					...
					if ($this->session === NULL) $this->session = new user_session_base($this);
					if ($this->details === NULL) $this->details = new user_detail_base($this);
		...
		// System functions
			...
			public function _cookie_get($name) { // Public for user_session_base to call
