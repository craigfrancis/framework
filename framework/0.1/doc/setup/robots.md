...
This is not a security feature, and should not be used to [protect private information](/doc/security/logins/). For that you might want to look at the [user helper](/doc/helpers/user/), or if you have a Demo site, just simply add a [HTTP Auth](http://httpd.apache.org/docs/2.2/howto/auth.html#gettingitworking).
