...
class Parser_Tags extends Parser_Driver {
...
//		}
	...
	{
		$string = parent::render($view);
		
		return static::parse_string($string, $data);
	}
	 ...
	 */
	public function parse_string($content, $data = array(), $callback = array())
	{
		...
		return $this->parse_php($this->parse_conditionals($orig_content), $data);
	}
